...
const page = () => {
  ...
  const AboutContent = {
    greenDescription: `We support our clients in finding the right persons to enable growth and excellence in their business areas. Our focus areas reflect our many years of experience. We have successfully conducted executive search consulting for C-level executives, managing directors, partners and other leadership roles.`,
