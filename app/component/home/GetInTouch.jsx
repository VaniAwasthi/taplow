          ...
          <form className="flex flex-col space-y-4">
            <div className="flex flex-col md:flex-row md:space-x-4">
              <input
                type="text"
                placeholder="Name"
                className="w-full md:w-1/2 md:my-0 my-2 p-2 bg-transparent border border-white rounded-3xl text-white placeholder-gray-300 focus:outline-none"
              />
              <input
                type="email"
                placeholder="Email"
                className="w-full md:w-1/2 p-2 md:my-0 my-2 bg-transparent border border-white rounded-3xl text-white placeholder-gray-300 focus:outline-none"
              />
            </div>
            <textarea
              placeholder="Message"
