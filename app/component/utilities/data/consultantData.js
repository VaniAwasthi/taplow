...
import Michael from "../../../assets/Consultantpage/Consultant/Michael-Van-Olm.webp";
import MikeCarter from "../../../assets/Consultantpage/Consultant/Mike-Carter.webp";
import OliverKuehm from "../../../assets/Consultantpage/Consultant/Oliver-Kuehm.webp";
import PaulCannon from "../../../assets/Consultantpage/Consultant/Paul-Cannon.webp";
import PaulMelanson from "../../../assets/Consultantpage/Consultant/Paul-Melanson.webp";
...
import TimRosenberg from "../../../assets/Consultantpage/Consultant/Tim-Rosenberg.webp";
import Pankajgoswami from "../../../assets/Consultantpage/Consultant/Pankaj-goswami.webp";
import AnoopSemwal from "../../../assets/Consultantpage/Consultant/Anoop-Semwal.webp";
import ShaistaSabharwal from "../../../assets/Consultantpage/Consultant/Shaista-Sabharwal.webp";
...
She received a Degree in International Relations from Le Mesnil in Montreux, Switzerland.  Ana speaks fluent English and French`,
  ...
  },
  {
    ...
    phone: "416-342-1505",
    email: "paul@macdonaldsearchgroup.com",
    image: PaulCannon,
    address: `Suite 300<br/>5100 Orbitor Drive<br/>Mississauga, ON L4W 4Z4`,
    linkdine: "https://www.linkedin.com/in/pcannon1/",
    industrySectors: [
      "Industrial",
      "Construction",
      "Engineering",
  ...
  },
  {
    ...
    services: ["Executive Search", "Board Services"],
    phone: "604-687-6464",
    email: "trevor@macdonaldsearchgroup.com",
    image: TrevorBaker,
    address: `Suite 720<br/>475 West Georgia St.<br/>Vancouver, BC V6B 4M9`,
    linkdine: "https://www.linkedin.com/in/trevoratmacdonaldsearchgroup/",
    industrySectors: [
      "Consumer Packaged Goods",
      "Beverage Alcohol",
      "Cannabis",
    ...
    bio: `With over 25 years of experience in sales, marketing, and leadership roles, Trevor is a trusted executive recruiter and coach who helps clients build amazing, high-performing teams in various industries, such as consumer packaged goods, healthcare, and e-commerce. He is also an Associate Certified Coach (ACC) from the International Coaching Federation, and a candidate for his Certified Professional in Human Resources (CPHR) designation.<br/><br/>
   As the Managing Director - Western Canada, of MacDonald Search Group, Trevor leverages his extensive network and industry knowledge to match outstanding candidates with incredible opportunities. He also consults with the other recruiters in his team and empowers them to deliver exceptional results. Trevor is passionate about creating true partnerships with his clients and candidates, and providing them with a deep and diverse perspective on their business and career challenges. Trevor is active in the community with various volunteer board roles and has been featured on multiple podcasts as a recruiting, leadership, sales and marketing expert.<br/><br/>
   Trevor's role is to lead the Western Canadian operations as a member of the Senior Leadership Team in conjunction with Bruce MacDonald and Paul Cannon. Additionally, Trevor works on senior level searches in Human Resources, and Executive Leadership.
`,
  },
  {
    id: 6,
    name: "James Palmer",
    role: "Senior Consultant / Partner - Vancouver",
    location: "Canada",
...
`,
    ...
    industrySectors: ["Industrial Products", "Distribution", "B2B"],
  },
  {
    id: 7,
    name: "Paul Melanson",
    role: "Senior Consultant & Partner - Atlantic Canada",
    location: "Canada",
    services: ["Executive Search"],
    phone: "902-593-0565",
    email: "paulm@macdonaldsearchgroup.com",
    image: PaulMelanson,
    address: `Unit 6<br/>430 Hazeldean Road<br/>Ottawa, ON K2L 1T9`,
    linkdine: "https://www.linkedin.com/in/pmelanson1/",
    industrySectors: [
      "Consumer Packaged Goods",
      "Food Service",
      "Beverage Alcohol",
      ...
      "Life Sciences",
      "Industrial",
      "Technical and Building Products",
...
`,
  ...
  },
  {
    ...
    services: ["Executive Search"],
    phone: "604-687-6464",
    email: "wade@macdonaldsearchgroup.com",
    image: WadeSimmons,
    address: `Suite 3720<br/>475 West Georgia St.<br/>Vancouver, BC V6B 4M9`,
    linkdine: "https://www.linkedin.com/in/wade-simmons-75512a6/",
    industrySectors: [
      "Consumer Products ",
      "Financial Services ",
      "Digital ",
...
`,
  ...
  {
    id: 10,
    name: "Michael Van Olm",
    role: "Senior Consultant / Partner – Calgary",
    location: "Canada",
    services: ["Executive Search"],
    phone: "403-444-6487",
    email: "michael@macdonaldsearchgroup.com",
    image: Michael,
    address: `Suite 503<br/>2303 - 4th Street SW<br/>Calgary, AB T2S 2S7`,
    linkdine: "https://www.linkedin.com/in/mvanolm/",
    industrySectors: [
      "Energy & Oil & Gas",
      "Industrial Products",
      "Building Products",
...
`,
  ...
  {
    id: 11,
    name: "Jennifer Klassen",
    role: "Senior Consultant - Calgary",
    location: "Canada",
    services: ["Executive Search"],
    phone: "403-444-6487",
...
`,
...

  {
    ...
    services: ["Executive Search"],
    phone: "416-342-1505 ",
    email: "mike@macdonaldsearchgroup.com",
    image: MikeCarter,

    address: `Suite 300<br/>5100 Orbitor Drive<br/>Mississauga, ON L4W 4Z4`,
    linkdine: "https://www.linkedin.com/in/mike-carter-09937851/",
    industrySectors: [
      "Industrial Products & Distribution",
      "B2B",
      "Business Operations",
...
From industrial sales with Fastenal managing a one-city territory, to B2B Sales with Michelin handling over $4M in annual sales to Tire Dealers, to his latest venture with Cintas working directly with the end-user, Mike has experience selling at all levels and building great professional relationships along the way.<br/><br/>
  ...
  },
  {
    ...
    services: ["Executive Search"],
    phone: "416-342-1505 ",
    email: "oliver@macdonaldsearchgroup.com",
    image: OliverKuehm,
    address: `Suite 300<br/>5100 Orbitor Drive<br/>Mississauga, ON L4W 4Z4`,
...
`,
...

  {
    ...
    image: StuartGannon,
    address: `Suite 503<br/>2303 - 4th Street SW<br/>Calgary, AB T2S 2S7`,
    linkdine: "https://www.linkedin.com/in/stuartgannon/",
    industrySectors: [
      "Consumer Packaged Goods",
      "Cannabis",
      "Beverage Alcohol",
...
`,
  ...
  //   },
  {
    ...
    role: "Managing Partner - Canada",
    location: "Canada",
    services: ["Executive Search", "Board Services"],
    phone: "604-687-6464",
    email: "bruce@macdonaldsearchgroup.com",
    image: BruceMacdonald,
    address: `Suite 720<br/>475 West Georgia St.<br/>Vancouver, BC V6B 4M9`,
  ...
  },
  {
    ...
    services: ["Executive Search", "Executive Interim", "Board Services"],
    phone: "+64 29 248 8502",
    email: "graeme@swr.nz",
    image: GraemeSandri,
...
and then New Zealand Business Development Manager.<br/><br/>
In 2014, Graeme and his now business partners Tony Walsh and Tim Rosenberg established SWR Executive Search
managing executive search assignments for clients across New Zealand. Throughout this time Graeme has focused
his executive search skills on C Suite and senior leadership roles. Graeme has also successfully completed a number
of Board appointments including Chair.
`,
  },
  {
    id: 22,
...
national and international clients in their quest to source talent across a wide range of management and leadership
roles in both public and private sectors, Tim has an extensive network and experience in matching client needs with
outstanding professionals.<br/><br/>
Tim also works across many other sectors and is always available to discuss how he might assist clients address their
talent needs.<br/>
Tim holds a Bachelor of Science (Hons) in Estate Management
`,
  },
  {
    id: 24,
...
Gurgaon-122002, Haryana`,
    ...
    bio: `Anoop Semwal brings over a decade of work experience in Leadership Consulting / Executive Search & Assessment. He focuses on advising clients on talent acquisition & assessment across different industries and geographies. Anoop is part of the founding team of Taplow Group India, and he concentrates on client management and delivering leadership roles for local & global markets and supports the firm in Business Development & Talent Management. He has successfully delivered leadership mandates across Consumer, Retail, Aviation, Automotive, Engineering, Lifestyle, Education, Technology & Infrastructure businesses<br/><br/>
...
`,
...

  {
    ...
    role: "Senior Partner",
    location: "Denmark",
    services: ["Executive Search", "Leadership Development"],
    phone: "+45 24859973",
    email: "clr@taplow.dk",
...
management, and as Marketing Director.`,
  },
  {
    ...
    role: "Managing Partner",
    location: "Norway",
    services: ["Executive Search", "Board Services", "Leadership advisory"],
    phone: "+47 4143 1847",
    email: "hhs@taplow.no",
...
I place great value on sustainability—in processes, recruitment, and diversity. Ensuring long-term impact and inclusive growth is central to how I think and lead teams, drive client success, and shape the organizations I work with. `,
  ...
  //   },
  {
    ...
    location: "Sweden",
    services: ["Executive Search Cosultant", "Executive Interim"],
    phone: "+46 708468856",
...
`,
  ...
  },
  {
    ...
    role: "Managing Partner",
    location: "Australia",
    services: ["Executive Search", "Board Services", "Executive Interim"],
