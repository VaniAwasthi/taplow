  ...
  return (
    <>
      <div className="relative w-[650px] hidden lg:flex items-center justify-center mt-[6rem] mb-[5rem] ">
        <div className="h-32  min-w-100%  relative translate-x-[149px] translate-y-[-40px] xl:translate-x-[175px] xl:translate-y-[-62px]">
          <Image
        ...
        <div className="flex ">
          <div className="h-32 min-w-100% relative translate-x-[-57px] translate-y-[77px] xl:translate-x-[-62px] xl:translate-y-[72px]">
            <Image
              className="object-contain transition-transform duration-300 ease-in-out hover:scale-105 "
              src={PerformanceImg}
              alt="Performance"
          ...
          <div className="h-32 min-w-100% relative translate-x-[-127px] translate-y-[76px] xl:translate-x-[-143px] xl:translate-y-[72px]">
            <Image
          ...
          <div className="h-32  min-w-100% relative translate-x-[-197px] translate-y-[78px] xl:translate-x-[-223px] xl:translate-y-[72px]">
            <Image
              className="object-contain transition-transform duration-300 ease-in-out hover:scale-105"
